        ...
        <div class="container">
            <section class="main row">
                <article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
                    ...
                    <p class="lead">Bootstrap is a free and open-source front-end web framework
                        ...
                        JavaScript extensions. <pre>Unlike many web frameworks, it concerns 
                        itself with front-end development only.</pre>
                    </div>
                </article>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-ms-6 col-md-3 bg-success">
                    ...
                    Mark Otto and Jacob Thornton at Twitter as a framework to encourage 
                    consistency across internal tools. Before Bootstrap, various libraries
                    were used for interface development, <u>which led to inconsistencies and a 
                        high maintenance burden. According to Twitter developer Mark Otto:</u>
                </div>
        ...
        <!--        <div class="row">
                    <blockquote class="blockquote-reverse">
                        Bootstrap, originally named Twitter Blueprint, was developed by
                            ...
                            <footer> Michael Mel̩ndez Mes̩n <cite title="Fuente">en fuente</cite> </footer>
                    </blockquote>
                </div>-->
        <footer>
            <div class="container">
                <h3>Michael Mel̩ndez Mes̩n</h3>
            </div>
        </footer>
        <script src="style/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="style/js/jquery-3.1.0.min.js" type="text/javascript"></script>
    </body>
</html>
